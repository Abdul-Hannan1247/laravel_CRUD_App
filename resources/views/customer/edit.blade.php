                    ...
                    <form action="{{ route('customers.update',$customer->id) }}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                <img style="width:100" src="{{ asset($customer->image) }}">
                            ...
                            <div class="col-md-6
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bank_account_number" class="form-control" value="{{ $customer->bank_account_number }}">
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        <label for="">About</label>
                                        <textarea name="about" class="form-control" >{{ $customer->about }}</textarea>                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
